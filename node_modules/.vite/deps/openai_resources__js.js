...
//#region node_modules/openai/internal/tslib.js
var require_tslib = /* @__PURE__ */ __commonJSMin(((exports) => {
...
//#endregion
//#region node_modules/openai/core/resource.js
...
//#endregion
//#region node_modules/openai/internal/errors.js
...
//#endregion
//#region node_modules/openai/core/error.js
...
//#endregion
//#region node_modules/openai/internal/shims.js
...
//#endregion
//#region node_modules/openai/internal/utils/bytes.js
...
var require_line = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	var LineDecoder = class {
		...
		flush() {
			if (!tslib_1.__classPrivateFieldGet(this, _LineDecoder_buffer, "f").length) return [];
			return this.decode("\n");
		}
	};
...
//#endregion
//#region node_modules/openai/internal/utils/values.js
...
//#endregion
//#region node_modules/openai/internal/utils/log.js
var require_log = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var parseLogLevel = (maybeLevel, sourceName, client) => {
		...
		if ((0, values_1.hasOwn)(levelNumbers, maybeLevel)) return maybeLevel;
...
//#endregion
//#region node_modules/openai/core/streaming.js
var require_streaming$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _Stream_client;
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	exports.Stream = class Stream {
		...
		static fromSSEResponse(response, controller, client, synthesizeEventData) {
			...
			async function* iterator() {
				if (consumed) throw new error_1.OpenAIError("Cannot iterate over a consumed stream, use `.tee()` to split the stream.");
				consumed = true;
				let done = false;
				try {
					for await (const sse of _iterSSEMessages(response, controller)) {
						...
						if (sse.event === null || !sse.event.startsWith("thread.")) {
							...
							if (data && data.error) throw new error_2.APIError(void 0, data.error, void 0, response.headers);
	...
	async function* _iterSSEMessages(response, controller) {
		if (!response.body) {
			controller.abort();
			if (typeof globalThis.navigator !== "undefined" && globalThis.navigator.product === "ReactNative") throw new error_1.OpenAIError(`The default react-native fetch implementation does not support streaming. Please use expo/fetch: https://docs.expo.dev/versions/latest/sdk/expo/#expofetch-api`);
...
//#endregion
//#region node_modules/openai/core/api-promise.js
var require_api_promise = /* @__PURE__ */ __commonJSMin(((exports) => {
	var _APIPromise_client;
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.APIPromise = void 0;
	var tslib_1 = require_tslib();
	var parse_1 = require_parse();
	exports.APIPromise = class APIPromise extends Promise {
		...
		*/
		...
		parse() {
			if (!this.parsedPromise) this.parsedPromise = this.responsePromise.then((data) => this.parseResponse(tslib_1.__classPrivateFieldGet(this, _APIPromise_client, "f"), data));
...
//#endregion
//#region node_modules/openai/core/pagination.js
var require_pagination = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var AbstractPage = class {
		...
		async getNextPage() {
			...
			if (!nextOptions) throw new error_1.OpenAIError("No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.");
...
//#endregion
//#region node_modules/openai/internal/utils/path.js
	...
	var Messages = class extends resource_1.APIResource {
		...
		*/
		list(completionID, query = {}, options) {
			return this._client.getAPIList((0, path_1.path)`/chat/completions/${completionID}/messages`, pagination_1.CursorPage, {
				query,
				...options
			});
		}
...
var require_error = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	require_tslib().__exportStar(require_error$1(), exports);
}));
//#endregion
...
var require_parser$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function parseChatCompletion(completion, params) {
		const choices = completion.choices.map((choice) => {
			...
			return {
				...
				message: {
					...choice.message,
					...choice.message.tool_calls ? { tool_calls: choice.message.tool_calls?.map((toolCall) => parseToolCall(params, toolCall)) ?? void 0 } : void 0,
	...
	function assertToolCallsAreChatCompletionFunctionToolCalls(toolCalls) {
		for (const toolCall of toolCalls || []) if (toolCall.type !== "function") throw new error_1.OpenAIError(`Currently only \`function\` tool calls are supported; Received \`${toolCall.type}\``);
	}
...
var require_EventStream = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var EventStream = class {
		...
		*/
		on(event, listener) {
			(tslib_1.__classPrivateFieldGet(this, _EventStream_listeners, "f")[event] || (tslib_1.__classPrivateFieldGet(this, _EventStream_listeners, "f")[event] = [])).push({ listener });
			return this;
		}
		/**
		...
		*/
		once(event, listener) {
			(tslib_1.__classPrivateFieldGet(this, _EventStream_listeners, "f")[event] || (tslib_1.__classPrivateFieldGet(this, _EventStream_listeners, "f")[event] = [])).push({
				listener,
				once: true
			});
			return this;
		...
		*/
		...
		_emit(event, ...args) {
			if (tslib_1.__classPrivateFieldGet(this, _EventStream_ended, "f")) return;
			if (event === "end") {
			...
			if (event === "abort") {
				const error = args[0];
				if (!tslib_1.__classPrivateFieldGet(this, _EventStream_catchingPromiseCreated, "f") && !listeners?.length) Promise.reject(error);
...
var require_AbstractChatCompletionRunner = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var AbstractChatCompletionRunner = class extends EventStream_1.EventStream {
		...
		_addMessage(message, emit = true) {
			...
			if (emit) {
				...
				if ((0, chatCompletionUtils_1.isToolMessage)(message) && message.content) this._emit("functionToolCallResult", message.content);
		...
		*/
		...
		_emitFinal() {
			...
			if (this._chatCompletions.some((c) => c.usage)) this._emit("totalUsage", tslib_1.__classPrivateFieldGet(this, _AbstractChatCompletionRunner_instances, "m", _AbstractChatCompletionRunner_calculateTotalUsage).call(this));
		}
	...
	_AbstractChatCompletionRunner_instances = /* @__PURE__ */ new WeakSet(), _AbstractChatCompletionRunner_getFinalContent = function _AbstractChatCompletionRunner_getFinalContent() {
		...
		for (let i = this.messages.length - 1; i >= 0; i--) {
			const message = this.messages[i];
			if ((0, chatCompletionUtils_1.isAssistantMessage)(message) && message?.tool_calls?.length) return message.tool_calls.filter((x) => x.type === "function").at(-1)?.function;
		}
...
var require_ChatCompletionRunner = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var chatCompletionUtils_1 = require_chatCompletionUtils();
	exports.ChatCompletionRunner = class ChatCompletionRunner extends AbstractChatCompletionRunner_1.AbstractChatCompletionRunner {
...
var require_streaming = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	require_tslib().__exportStar(require_streaming$1(), exports);
}));
//#endregion
...
var require_ChatCompletionStream = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var error_1 = require_error();
	var parser_2 = require_parser$1();
	var streaming_1 = require_streaming();
	var AbstractChatCompletionRunner_1 = require_AbstractChatCompletionRunner();
	exports.ChatCompletionStream = class ChatCompletionStream extends AbstractChatCompletionRunner_1.AbstractChatCompletionRunner {
		constructor(params) {
			super();
		...
		*/
		...
		async _createChatCompletion(client, params, options) {
			...
			this._connected();
			for await (const chunk of stream) tslib_1.__classPrivateFieldGet(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_addChunk).call(this, chunk);
		...
		async _fromReadableStream(readableStream, options) {
			...
			for await (const chunk of stream) {
				if (chatId && chatId !== chunk.id) this._addChatCompletion(tslib_1.__classPrivateFieldGet(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_endRequest).call(this));
		...
		[(_ChatCompletionStream_params = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_choiceEventStates = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_currentChatCompletionSnapshot = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_instances = /* @__PURE__ */ new WeakSet(), _ChatCompletionStream_beginRequest = function _ChatCompletionStream_beginRequest() {
			...
			for (const choice of chunk.choices) {
				...
				if (choiceSnapshot.finish_reason) {
					...
					if (state.current_tool_call_index != null) tslib_1.__classPrivateFieldGet(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_emitToolCallDoneEvent).call(this, choiceSnapshot, state.current_tool_call_index);
				}
			...
			if (tslib_1.__classPrivateFieldGet(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_getChoiceEventState).call(this, choiceSnapshot).done_tool_calls.has(toolCallIndex)) return;
			...
			if ((0, parser_2.isAutoParsableResponseFormat)(responseFormat)) return responseFormat;
			return null;
			...
			if (!snapshot) snapshot = tslib_1.__classPrivateFieldSet(this, _ChatCompletionStream_currentChatCompletionSnapshot, {
				...rest,
				choices: []
			}, "f");
			...
			for (const { delta, finish_reason, index, logprobs = null, ...other } of chunk.choices) {
				...
				if (content) {
					...
					if (!choice.message.refusal && tslib_1.__classPrivateFieldGet(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_getAutoParseableResponseFormat).call(this)) choice.message.parsed = (0, parser_1.partialParse)(choice.message.content);
				}
				if (tool_calls) {
					...
					for (const { index, id, type, function: fn, ...rest } of tool_calls) {
						...
						if (fn?.arguments) {
							...
							if ((0, parser_2.shouldParseToolCall)(tslib_1.__classPrivateFieldGet(this, _ChatCompletionStream_params, "f"), tool_call)) tool_call.function.parsed_arguments = (0, parser_1.partialParse)(tool_call.function.arguments);
						}
					}
				}
			}
...
var require_ChatCompletionStreamingRunner = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.ChatCompletionStreamingRunner = class ChatCompletionStreamingRunner extends ChatCompletionStream_1.ChatCompletionStream {
		static fromReadableStream(stream) {
...
var require_completions$2 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var tslib_1 = require_tslib();
	var resource_1 = require_resource();
	var MessagesAPI = tslib_1.__importStar(require_messages$1());
...
var require_chat$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var tslib_1 = require_tslib();
	var resource_1 = require_resource();
	var CompletionsAPI = tslib_1.__importStar(require_completions$2());
	var completions_1 = require_completions$2();
...
var require_completions$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	tslib_1.__exportStar(require_completions$2(), exports);
	var messages_1 = require_messages$1();
...
var require_chat = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var index_1 = require_completions$1();
	Object.defineProperty(exports, "Completions", {
		enumerable: true,
		get: function() {
...
//#endregion
//#region node_modules/openai/internal/headers.js
var require_headers = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function* iterateHeaders(headers) {
		...
		else if ((0, values_1.isReadonlyArray)(headers)) iter = headers;
		else {
			shouldClear = true;
...
//#endregion
//#region node_modules/openai/internal/uploads.js
var require_uploads$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	var addFormValue = async (form, key, value) => {
		...
		else if ((0, exports.isAsyncIterable)(value)) form.append(key, makeFile([await new Response((0, shims_1.ReadableStreamFrom)(value)).blob()], getName(value)));
...
var require_transcriptions = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var resource_1 = require_resource();
	var uploads_1 = require_uploads$1();
	/**
	* Turn audio into text or text into audio.
	*/
...
var require_translations = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	var Translations = class extends resource_1.APIResource {
		create(body, options) {
			return this._client.post("/audio/translations", (0, uploads_1.multipartFormRequestOptions)({
				body,
				...options,
				__metadata: { model: body.model }
			}, this._client));
...
var require_sessions$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_realtime$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.Realtime = void 0;
	var tslib_1 = require_tslib();
	var resource_1 = require_resource();
	var SessionsAPI = tslib_1.__importStar(require_sessions$1());
	var sessions_1 = require_sessions$1();
...
//#endregion
//#region node_modules/openai/resources/beta/chatkit/sessions.js
...
//#endregion
//#region node_modules/openai/resources/beta/chatkit/threads.js
var require_threads$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/openai/resources/beta/chatkit/chatkit.js
var require_chatkit = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var ThreadsAPI = tslib_1.__importStar(require_threads$1());
	var threads_1 = require_threads$1();
...
//#endregion
//#region node_modules/openai/internal/utils/base64.js
var require_base64 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var toBase64 = (data) => {
		...
		if (typeof data === "string") data = (0, bytes_1.encodeUTF8)(data);
		if (typeof btoa !== "undefined") return btoa(String.fromCharCode.apply(null, data));
...
//#endregion
//#region node_modules/openai/internal/utils/env.js
...
//#endregion
//#region node_modules/openai/internal/utils/uuid.js
...
//#endregion
//#region node_modules/openai/internal/utils/sleep.js
...
var require_utils$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function merge(target, source, options = {}) {
		...
		if (typeof source !== "object") {
			if ((0, values_1.isArray)(target)) target.push(source);
			else if (target && typeof target === "object") {
				if (options && (options.plainObjects || options.allowPrototypes) || !(0, exports.has)(Object.prototype, source)) target[source] = true;
			} else return [target, source];
			return target;
		}
		if (!target || typeof target !== "object") return [target].concat(source);
		let mergeTarget = target;
		if ((0, values_1.isArray)(target) && !(0, values_1.isArray)(source)) mergeTarget = array_to_object(target, options);
		...
		return Object.keys(source).reduce(function(acc, key) {
			...
			if ((0, exports.has)(acc, key)) acc[key] = merge(acc[key], value, options);
			else acc[key] = value;
			return acc;
		}, mergeTarget);
	}
	...
	var encode = (str, _defaultEncoder, charset, _kind, format) => {
		...
		for (let j = 0; j < string.length; j += limit) {
			...
			for (let i = 0; i < segment.length; ++i) {
				...
				if (c === 45 || c === 46 || c === 95 || c === 126 || c >= 48 && c <= 57 || c >= 65 && c <= 90 || c >= 97 && c <= 122 || format === formats_1.RFC1738 && (c === 40 || c === 41)) {
...
var require_stringify = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function inner_stringify(object, prefix, generateArrayPrefix, commaRoundTrip, allowEmptyArrays, strictNullHandling, skipNulls, encodeDotInKeys, encoder, filter, sort, allowDots, serializeDate, format, formatter, encodeValuesOnly, charset, sideChannel) {
		...
		else if (generateArrayPrefix === "comma" && (0, values_1.isArray)(obj)) obj = (0, utils_1.maybe_map)(obj, function(value) {
		...
		} else if ((0, values_1.isArray)(filter)) obj_keys = filter;
		else {
			const keys = Object.keys(obj);
		...
		if (allowEmptyArrays && (0, values_1.isArray)(obj) && obj.length === 0) return adjusted_prefix + "[]";
		for (let j = 0; j < obj_keys.length; ++j) {
			...
			push_to_array(values, inner_stringify(value, key_prefix, generateArrayPrefix, commaRoundTrip, allowEmptyArrays, strictNullHandling, skipNulls, encodeDotInKeys, generateArrayPrefix === "comma" && encodeValuesOnly && (0, values_1.isArray)(obj) ? null : encoder, filter, sort, allowDots, serializeDate, format, formatter, encodeValuesOnly, charset, valueSideChannel));
		}
		return values;
	}
	function normalize_stringify_options(opts = defaults) {
		...
		if (typeof opts.format !== "undefined") {
			if (!(0, utils_1.has)(formats_1.formatters, opts.format)) throw new TypeError("Unknown format option provided.");
			format = opts.format;
		}
		const formatter = formats_1.formatters[format];
		let filter = defaults.filter;
		if (typeof opts.filter === "function" || (0, values_1.isArray)(opts.filter)) filter = opts.filter;
		let arrayFormat;
...
//#endregion
//#region node_modules/openai/internal/utils/query.js
var require_query = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.stringifyQuery = stringifyQuery;
	var qs = require_tslib().__importStar(require_stringify());
	function stringifyQuery(query) {
		return qs.stringify(query, { arrayFormat: "brackets" });
	}
}));
//#endregion
//#region node_modules/openai/internal/utils.js
...
var require_AssistantStream = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var AssistantStream = class extends EventStream_1.EventStream {
		...
		async _fromReadableStream(readableStream, options) {
			...
			this._connected();
			const stream = streaming_1.Stream.fromReadableStream(readableStream, this.controller);
			for await (const event of stream) tslib_1.__classPrivateFieldGet(this, _AssistantStream_instances, "m", _AssistantStream_addEvent).call(this, event);
			if (stream.controller.signal?.aborted) throw new error_1.APIUserAbortError();
		...
		static accumulateDelta(acc, delta) {
			for (const [key, deltaValue] of Object.entries(delta)) {
				...
				if (typeof accValue === "string" && typeof deltaValue === "string") accValue += deltaValue;
				...
				else if ((0, utils_1.isObj)(accValue) && (0, utils_1.isObj)(deltaValue)) accValue = this.accumulateDelta(accValue, deltaValue);
					...
					for (const deltaEntry of deltaValue) {
						if (!(0, utils_1.isObj)(deltaEntry)) throw new Error(`Expected array delta entry to be an object but got: ${deltaEntry}`);
	...
	_a = AssistantStream, _AssistantStream_addEvent = function _AssistantStream_addEvent(event) {
		...
		switch (event.event) {
			...
			case "thread.message.delta":
				...
				if (event.data.delta.content) for (const content of event.data.delta.content) {
					...
					if (content.index != tslib_1.__classPrivateFieldGet(this, _AssistantStream_currentContentIndex, "f")) {
						if (tslib_1.__classPrivateFieldGet(this, _AssistantStream_currentContent, "f")) switch (tslib_1.__classPrivateFieldGet(this, _AssistantStream_currentContent, "f").type) {
							case "text":
			...
			case "thread.message.incomplete":
				...
				if (tslib_1.__classPrivateFieldGet(this, _AssistantStream_messageSnapshot, "f")) this._emit("messageDone", event.data);
		...
		switch (event.event) {
			...
			case "thread.run.step.delta":
				...
				if (delta.step_details && delta.step_details.type == "tool_calls" && delta.step_details.tool_calls && accumulatedRunStep.step_details.type == "tool_calls") for (const toolCall of delta.step_details.tool_calls) if (toolCall.index == tslib_1.__classPrivateFieldGet(this, _AssistantStream_currentToolCallIndex, "f")) this._emit("toolCallDelta", toolCall, accumulatedRunStep.step_details.tool_calls[toolCall.index]);
					...
					if (tslib_1.__classPrivateFieldGet(this, _AssistantStream_currentToolCall, "f")) this._emit("toolCallDone", tslib_1.__classPrivateFieldGet(this, _AssistantStream_currentToolCall, "f"));
...
var require_threads = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var RunsAPI = tslib_1.__importStar(require_runs$1());
	var runs_1 = require_runs$1();
	var headers_1 = require_headers();
	var AssistantStream_1 = require_AssistantStream();
	var path_1 = require_path();
	/**
...
var require_beta = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var RealtimeAPI = tslib_1.__importStar(require_realtime$1());
	var realtime_1 = require_realtime$1();
...
var require_content$2 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_files$2 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var tslib_1 = require_tslib();
	var resource_1 = require_resource();
	var ContentAPI = tslib_1.__importStar(require_content$2());
	var content_1 = require_content$2();
	var pagination_1 = require_pagination();
	var headers_1 = require_headers();
	var uploads_1 = require_uploads$1();
	var path_1 = require_path();
	var Files = class extends resource_1.APIResource {
		...
		*/
		create(containerID, body, options) {
			return this._client.post((0, path_1.path)`/containers/${containerID}/files`, (0, uploads_1.maybeMultipartFormRequestOptions)({
				body,
				...options
			}, this._client));
		}
...
var require_containers = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var tslib_1 = require_tslib();
	var resource_1 = require_resource();
	var FilesAPI = tslib_1.__importStar(require_files$2());
	var files_1 = require_files$2();
	var pagination_1 = require_pagination();
	var headers_1 = require_headers();
	var path_1 = require_path();
...
//#endregion
//#region node_modules/openai/resources/conversations/items.js
	...
	var Items = class extends resource_1.APIResource {
		...
		*/
		list(conversationID, query = {}, options) {
			return this._client.getAPIList((0, path_1.path)`/conversations/${conversationID}/items`, pagination_1.ConversationCursorPage, {
				query,
				...options
			});
		}
...
//#endregion
//#region node_modules/openai/resources/conversations/conversations.js
var require_conversations = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var Embeddings = class extends resource_1.APIResource {
		...
		*/
		create(body, options) {
			...
			if (hasUserProvidedEncodingFormat) (0, utils_1.loggerFor)(this._client).debug("embeddings/user defined encoding_format:", body.encoding_format);
	...
	var OutputItems = class extends resource_1.APIResource {
		...
		*/
		list(runID, params, options) {
			...
			return this._client.getAPIList((0, path_1.path)`/evals/${eval_id}/runs/${runID}/output_items`, pagination_1.CursorPage, {
				query,
				...options
			});
		}
	...
	var Evals = class extends resource_1.APIResource {
		...
		*/
		update(evalID, body, options) {
			return this._client.post((0, path_1.path)`/evals/${evalID}`, {
				body,
				...options
			});
		}
...
var require_files$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	var Files = class extends resource_1.APIResource {
		...
		*/
		create(body, options) {
			return this._client.post("/files", (0, uploads_1.multipartFormRequestOptions)({
				body,
				...options
			}, this._client));
		}
		...
		*/
		async waitForProcessing(id, { pollInterval = 5e3, maxWait = 1800 * 1e3 } = {}) {
			...
			while (!file.status || !TERMINAL_STATES.has(file.status)) {
				...
				if (Date.now() - start > maxWait) throw new error_1.APIConnectionTimeoutError({ message: `Giving up on waiting for file ${id} to finish processing after ${maxWait} milliseconds.` });
			}
			return file;
		}
	};
...
var require_alpha = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var tslib_1 = require_tslib();
	var resource_1 = require_resource();
	var GradersAPI = tslib_1.__importStar(require_graders$1());
	var graders_1 = require_graders$1();
	...
	var Permissions = class extends resource_1.APIResource {
		...
		*/
		create(fineTunedModelCheckpoint, body, options) {
			return this._client.getAPIList((0, path_1.path)`/fine_tuning/checkpoints/${fineTunedModelCheckpoint}/permissions`, pagination_1.Page, {
				body,
				method: "post",
				...options
			});
		...
		*/
		list(fineTunedModelCheckpoint, query = {}, options) {
			return this._client.getAPIList((0, path_1.path)`/fine_tuning/checkpoints/${fineTunedModelCheckpoint}/permissions`, pagination_1.ConversationCursorPage, {
				query,
				...options
			});
		}
	...
	var Checkpoints = class extends resource_1.APIResource {
		...
		*/
		list(fineTuningJobID, query = {}, options) {
			return this._client.getAPIList((0, path_1.path)`/fine_tuning/jobs/${fineTuningJobID}/checkpoints`, pagination_1.CursorPage, {
				query,
				...options
			});
		}
	...
	var Jobs = class extends resource_1.APIResource {
		...
		*/
		listEvents(fineTuningJobID, query = {}, options) {
			return this._client.getAPIList((0, path_1.path)`/fine_tuning/jobs/${fineTuningJobID}/events`, pagination_1.CursorPage, {
				query,
				...options
			});
		}
...
var require_fine_tuning = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var CheckpointsAPI = tslib_1.__importStar(require_checkpoints$1());
	var checkpoints_1 = require_checkpoints$1();
	...
	var Images = class extends resource_1.APIResource {
		...
		*/
		createVariation(body, options) {
			return this._client.post("/images/variations", (0, uploads_1.multipartFormRequestOptions)({
				body,
				...options
			}, this._client));
		}
		edit(body, options) {
			return this._client.post("/images/edits", (0, uploads_1.multipartFormRequestOptions)({
				body,
				...options,
				stream: body.stream ?? false
			}, this._client));
...
//#endregion
//#region node_modules/openai/resources/realtime/calls.js
...
//#endregion
//#region node_modules/openai/resources/realtime/client-secrets.js
var require_client_secrets = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/openai/resources/realtime/realtime.js
...
var require_ResponseStream = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.ResponseStream = class ResponseStream extends EventStream_1.EventStream {
		constructor(params) {
			super();
		...
		async _createOrRetrieveResponse(client, params, options) {
			...
			this._connected();
			for await (const event of stream) tslib_1.__classPrivateFieldGet(this, _ResponseStream_instances, "m", _ResponseStream_addEvent).call(this, event, starting_after);
			if (stream.controller.signal?.aborted) throw new error_1.APIUserAbortError();
			...
			switch (event.type) {
				...
				case "response.reasoning_text.delta": {
					...
					if (output.type === "reasoning") {
						const content = output.content?.[event.content_index];
						if (!content) throw new error_1.OpenAIError(`missing content at index ${event.content_index}`);
						if (content.type !== "reasoning_text") throw new error_1.OpenAIError(`expected content to be 'reasoning_text', got ${content.type}`);
						content.text += event.delta;
					}
					break;
				}
	...
	var InputItems = class extends resource_1.APIResource {
		...
		*/
		list(responseID, query = {}, options) {
			return this._client.getAPIList((0, path_1.path)`/responses/${responseID}/input_items`, pagination_1.CursorPage, {
				query,
				...options
			});
		}
...
//#endregion
//#region node_modules/openai/resources/responses/input-tokens.js
var require_input_tokens = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/openai/resources/skills/content.js
...
//#endregion
//#region node_modules/openai/resources/skills/versions/content.js
...
//#endregion
//#region node_modules/openai/resources/skills/versions/versions.js
	...
	var Versions = class extends resource_1.APIResource {
		...
		*/
		create(skillID, body = {}, options) {
			return this._client.post((0, path_1.path)`/skills/${skillID}/versions`, (0, uploads_1.maybeMultipartFormRequestOptions)({
				body,
				...options
			}, this._client));
		}
...
//#endregion
//#region node_modules/openai/resources/skills/skills.js
var require_skills = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.Skills = void 0;
	var tslib_1 = require_tslib();
	var resource_1 = require_resource();
	var ContentAPI = tslib_1.__importStar(require_content$1());
	var content_1 = require_content$1();
	...
	var Skills = class extends resource_1.APIResource {
		...
		*/
		create(body = {}, options) {
			return this._client.post("/skills", (0, uploads_1.maybeMultipartFormRequestOptions)({
				body,
				...options
			}, this._client));
		}
	...
	var Parts = class extends resource_1.APIResource {
		...
		*/
		create(uploadID, body, options) {
			return this._client.post((0, path_1.path)`/uploads/${uploadID}/parts`, (0, uploads_1.multipartFormRequestOptions)({
				body,
				...options
			}, this._client));
		}
...
//#endregion
//#region node_modules/openai/resources/videos.js
var require_videos = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var Videos = class extends resource_1.APIResource {
		...
		*/
		create(body, options) {
			return this._client.post("/videos", (0, uploads_1.multipartFormRequestOptions)({
				body,
				...options
			}, this._client));
		}
		...
		*/
		createCharacter(body, options) {
			return this._client.post("/videos/characters", (0, uploads_1.multipartFormRequestOptions)({
				body,
				...options
			}, this._client));
		}
		...
		*/
		edit(body, options) {
			return this._client.post("/videos/edits", (0, uploads_1.multipartFormRequestOptions)({
				body,
				...options
			}, this._client));
		}
		...
		*/
		extend(body, options) {
			return this._client.post("/videos/extensions", (0, uploads_1.multipartFormRequestOptions)({
				body,
				...options
			}, this._client));
		}
		...
		*/
		remix(videoID, body, options) {
			return this._client.post((0, path_1.path)`/videos/${videoID}/remix`, (0, uploads_1.maybeMultipartFormRequestOptions)({
				body,
				...options
			}, this._client));
		}
...
//#endregion
//#region node_modules/openai/resources/webhooks/webhooks.js
var require_webhooks$2 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var Webhooks = class extends resource_1.APIResource {
		...
		*/
		async verifySignature(payload, headers, secret = this._client.webhookSecret, tolerance = 300) {
			...
			if (isNaN(timestampSeconds)) throw new error_1.InvalidWebhookSignatureError("Invalid webhook timestamp format");
			const nowSeconds = Math.floor(Date.now() / 1e3);
			if (nowSeconds - timestampSeconds > tolerance) throw new error_1.InvalidWebhookSignatureError("Webhook timestamp is too old");
			if (timestampSeconds > nowSeconds + tolerance) throw new error_1.InvalidWebhookSignatureError("Webhook timestamp is too new");
...
//#endregion
//#region node_modules/openai/resources/webhooks/index.js
var require_webhooks$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	require_tslib().__exportStar(require_webhooks$2(), exports);
}));
//#endregion
//#region node_modules/openai/resources/webhooks.js
var require_webhooks = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	require_tslib().__exportStar(require_webhooks$1(), exports);
}));
//#endregion
//#region node_modules/openai/resources/index.js
var require_resources$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/openai/resources.js
var require_resources = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	require_tslib().__exportStar(require_resources$1(), exports);
}));
//#endregion
export default require_resources();

//# sourceMappingURL=openai_resources__js.js.map